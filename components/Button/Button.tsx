  ...
  return (
    <button
      ...
      className={clsx(
        ...
        size === "sm" &&
          (variant === "text-only" ? textOnlySmSizing : smSizing),
        size === "base" &&
          (variant === "text-only" ? textOnlyBaseSizing : baseSizing),
        size === "lg" &&
          (variant === "text-only" ? textOnlyLgSizing : lgSizing),
        props.className
      )}
...
const flex = clsx("flex flex-row justify-center items-center gap-1");
