...
export default function Spinner({loading, success, error, size}: ISpinnerProps) {
  return (
    <div className='relative' style={{width: size, height: size}}>
      {loading && <div className=' flex flex-row items-center justify-center w-full h-full'><PulseLoader loading size={size!/6} color={'#5A4FF3'} margin={size!/16}/></div>}
